...
const Contact = (props)=>{
    return(
        ...
        style={{
            ...
            <div className="col-2 col-md-1 pt-2 pt-md-2">
        ...
        <div className="col-2 col-md-2 pt-md-3">
            <button className={`btn btn-sm m-1 ${
                props.contact.isFavorite ? "btn btn-warning" : "btn btn-outline-warning"
                }`}
                onClick={()=>props.FavriotClick(props.contact)}
                >
        ...
        <div className="col-2 col-md-2 pt-md-3">
            ...
            onClick={()=>props.updatedclick(props.contact)}
            style={{fontSize:"1rem"}}></i>
          </button>
          <button className="btn btn-danger btn-sm m-1"
          
          >
            <i className="bi bi-trash-fill" onClick={()=>props.ClickDelete(props.contact.id)}
            style={{fontSize:"1rem"}}></i>
          </button>
        </div>
